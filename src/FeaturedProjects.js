    ...
    render() {
        return (
            <div id="projects" className="featured-projects-ctn-ctn">
                ...
                <h1 className="featured-project-name mobile-title" >Yelp API</h1>
                <div className="featured-project-ctn">
                    ...
                    <div className="featured-project-summary-ctn">
                        <h1 className="featured-project-name title-right-desktop">Yelp API</h1>
                        <h2 className="featured-project-summary yelp-summary">Search for different businesses in any location with reviews/ratings using an API from the Yelp Servers.</h2>
                        <div className="lightbulb-ctn">
                            
                            <h2 className="more-info"><img src={lightbulb} alt="" className="lightbulb"/> FULLY FUNCTIONAL</h2>
                        </div>
                ...
                <h1 className="featured-project-name mobile-title" >Invision Clone</h1>
                <div className="featured-project-ctn">
                    
                    <div className="featured-project-summary-ctn desktop">
                        <h1 className="featured-project-name title-left-desktop">Invision Clone</h1>
                        <h2 className="featured-project-summary">A perfect clone of Invision App's home website.</h2>
                        <div className="lightbulb-ctn">
                           
                            <h2 className="more-info"> <img src={lightbulb} alt="" className="lightbulb"/>EXACT REPLICA</h2>
                        </div>
                    ...
                    <div className="featured-project-summary-ctn invision-summary mobile">
                        <h1 className="featured-project-name title-left-desktop">Invision Clone</h1>
                        <h2 className="featured-project-summary">A perfect clone of Invision App's home website.</h2>
                        <div className="lightbulb-ctn">
                ...
                <h1 className="featured-project-name mobile-title" >Trick Creator</h1>
                <div id="trick-creator--img-ctn" className="featured-project-ctn">
                    <div  className="img-ctn">
                        <img src={trickImage1} alt="The Trick Creator Website"  className="trick-creator"/>
                        <img src={trickImage2} alt="The Trick Creator Website" id="trick-creator-img" className="trick-creator"/>
                    </div>
                    <div className="featured-project-summary-ctn">
                        <h1 className="featured-project-name title-right-desktop">Trick Creator</h1>
                        <h2 className="featured-project-summary trick-creator-summary">A simple game that allows you to combine tricks to make more and more complex tricks.</h2>
                        <div className="lightbulb-ctn">
                            
                            <h2 className="more-info"><img src={lightbulb} alt="" className="lightbulb"/> OWN CONCEPT</h2>
                        </div>
                        <h2 className="more-info"><svg className="computer-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M7 17H2a2 2 0 0 1-2-2V2C0 .9.9 0 2 0h16a2 2 0 0 1 2 2v13a2 2 0 0 1-2 2h-5l4 2v1H3v-1l4-2zM2 2v11h16V2H2z"></path></svg>BUILT FROM SCRATCH</h2>
